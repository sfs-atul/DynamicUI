    ...
    _renderContent = () => {
        ...
        let content = <View style={{ marginVertical: wp('5%'), marginHorizontal: hp('4%') }}>
            ...
            <View style={{ flexDirection: 'row', paddingHorizontal: wp('4%'), paddingVertical: hp('2%'), justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Text style={{ fontSize: hp('2%'), color: '#3F495D' }}>Travel Schedule</Text>
                    <TouchableOpacity><Image source={up_arrow} style={{ height: hp('4%'), width: wp('4%'), resizeMode: 'contain' }} /></TouchableOpacity>
                </View>
            </View>
                ...
                <KeyboardAwareScrollView>
                    ...
                    <View style={{ marginVertical: wp('5%'), marginHorizontal: hp('4%') }}>
                        <View
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: wp('4%'), paddingBottom: hp('2%'), }}>
                                <TextInput
                                    placeholder='Add Travel Documents'
                                    placeholderTextColor='#9DA6B8'
                                    style={{ fontSize: hp('2%') }}
                                />
                                {/* Add Button */}
                    ...
                    {/* Documents End */}
                    <Accordion dataArray={TravelPlannerArray} renderContent={this._renderContent} expanded={0} />
